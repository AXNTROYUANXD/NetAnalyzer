...
public class NetAnalyser extends JFrame implements ActionListener {
    ...
    public void initialization() {
        ...
        probesJComboBox.addItem("1");
        probesJComboBox.addItem("2");
        probesJComboBox.addItem("3");
        probesJComboBox.addItem("4");
        probesJComboBox.addItem("5");
        probesJComboBox.addItem("6");
        probesJComboBox.addItem("7");
        probesJComboBox.addItem("8");
        probesJComboBox.addItem("9");
        probesJComboBox.addItem("10");
        //Add ten selections.
    ...
    public void actionPerformed(ActionEvent event) {
         ...
         * Also, shows the RTT histogram in the GUI.
